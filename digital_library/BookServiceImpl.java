...
public class BookServiceImpl {
	...
	public void showAllBooks() {
		...
		System.out.println(
				"\n----------------------------------------------------------------------------------------------");
		System.out.format(CYAN + "%s%15s%16s%20s%17s", "ID", "TITLE", "AUTHOR", "PUBLISH YEAR", "STATUS" + RESET);
		System.out.println(
				"\n----------------------------------------------------------------------------------------------");

		for (Book book : books) {
			System.out.format("%s%15s%16s%16s%19s", book.getId(), book.getTitle(), book.getAuthor(),
	...
	public void borrowBook() {
		...
		for (Book book : books) {
			if (book.getId().equals(bookid) && book.getStatus().equals("Available")) {
				...
				System.out.format("Borrowed Book Details: "+CYAN +"\nID: " +RESET+ book.getId() +CYAN +"\nTITLE: " +RESET+ book.getTitle()
				+ CYAN+"\nAUTHOR: "+RESET + book.getAuthor() + CYAN+"\nPUBLISH YEAR: "+RESET + book.getPublishYear() + "\n"+"\n");
			}
		}
		if (flag == false)
	...
	public void returnBook() {
		...
		for (Book book : books) {
			if (book.getId().equals(bookid) && book.getStatus().equals("Not Available")) {
				...
				System.out.format("Returned Book Details: "+CYAN +"\nID: " +RESET+ book.getId() +CYAN +"\nTITLE: " +RESET+ book.getTitle()
				+ CYAN+"\nAUTHOR: "+RESET + book.getAuthor() + CYAN+"\nPUBLISH YEAR: "+RESET + book.getPublishYear() + "\n"+"\n");
			}
